...
:::tip
The checklist will also include items marked as incomplete (_pending_, _constraint_), to ensure you have the reminders in one place.
:::
...
<img src="/trip/img/trip_packinglist.png" alt="Trip - Packing list" />
