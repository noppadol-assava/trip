...
def upgrade():
    op.create_table(
        "tripbookingattachmentlink",
        sa.Column("booking_id", sa.Integer(), nullable=False),
        sa.Column("attachment_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["attachment_id"],
            ["tripattachment.id"],
            name=op.f("fk_tripbookingattachmentlink_attachment_id_tripattachment"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["booking_id"],
            ["tripbooking.id"],
            name=op.f("fk_tripbookingattachmentlink_booking_id_tripbooking"),
            ondelete="CASCADE",
        ),
    ...
    with op.batch_alter_table("tripbookingattachmentlink", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_tripbookingattachmentlink_booking_id"), ["booking_id"], unique=False
        )
